    ...
    <PageWrapper title="">
      <div className="mt-8 space-y-12">
        ...
        <div>
          ...
          <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
            <Link href="/range-study" className="block">
              <div className="bg-gray-900 overflow-hidden shadow rounded-lg border border-gray-800 hover:bg-gray-800 hover:border-gray-700 transition-all duration-200">
                <div className="px-4 py-5 sm:p-6">
                  <h3 className="text-lg font-medium text-gray-100">Range Study</h3>
                  <p className="mt-2 text-sm text-gray-300">
                    Study preflop ranges for different positions.
                  </p>
                </div>
              </div>
            </Link>
            <Link href="/range-practice" className="block">
              <div className="bg-gray-900 overflow-hidden shadow rounded-lg border border-gray-800 hover:bg-gray-800 hover:border-gray-700 transition-all duration-200">
                <div className="px-4 py-5 sm:p-6">
                  <h3 className="text-lg font-medium text-gray-100">Range Practice</h3>
                  <p className="mt-2 text-sm text-gray-300">
                    Test your range knowledge by recreating ranges on a grid.
                  </p>
                </div>
              </div>
            </Link>
            <Link href="/hand-practice" className="block">
              <div className="bg-gray-900 overflow-hidden shadow rounded-lg border border-gray-800 hover:bg-gray-800 hover:border-gray-700 transition-all duration-200">
                <div className="px-4 py-5 sm:p-6">
